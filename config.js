const config = {
    ...
    'rssurl': {
        'Scitech': ['https://newatlas.com/science/index.rss', 'https://www.cbsnews.com/latest/rss/science', 'https://www.cbsnews.com/latest/rss/space', 'http://warisboring.com/feed/'],
