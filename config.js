const config = {
    ...
    'excludeTerms': ['Black Friday', 'Cyber Monday', 'AQI', 'NEET', 'Pee-Gate', 'pee-gate', 'pee gate', 'Pee Gate', 'Bharat Jodo', 'monkeypox', 'covid', 'COVID', 'corona', 'Moosewala', 'Nupur Sharma', 'Morbi', 'Aftab', 'Shraddha', 'Moose Wala', 'iTunes', 'iPhone', 'iPad', 'smartwatch', 'iOS', 'Watch', 'macOS', 'watchOS', 'Prime Day', 'Garmin', 'Amazfit', 'Fitbit', 'Google Pixel', 'Pixel 6', 'Pixel 7', 'Sex Toy'], // Exclude any titles with these terms. Case-sensitive
    'includeTerms': [], // Include any titles with these terms. Overrides exclude terms. Case-sensitive
    'rssurl': {'Scitech': ['https://knowablemagazine.org/rss', 'https://physicsworld.com/feed/', 'https://www.annualreviews.org/rss/content/journals/astro/latestarticles?fmt=rss', 'https://www.quantamagazine.org/feed/'],
