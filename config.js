const config = {
    ...
    'rssurl': {'Scitech': ['https://knowablemagazine.org/rss', 'https://physicsworld.com/feed/', 'https://www.annualreviews.org/rss/content/journals/astro/latestarticles?fmt=rss'],
